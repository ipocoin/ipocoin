IPOCoin (ICN) - a 'faster' version of Litecoin which also uses scrypt
as a proof of work scheme and is intended for microtransactions.
 - 300 seconds block targets: beat that MinCoin! ;)
 - 2 000 000 total coins
 - no subsidy within the first 3 days and after approximately 5 years;
    in between: 1 coin(s) per generated block
 - difficulty retargets every 1 day(s)
...
So actually, this 'new' coin exists for the following reasons:
 - ICN proves that really anyone(!) can start a Litecoin/Bitcoin based currency
...
Finally, I only tested the command line server/tool 'ipocoin' for the
