...
uint256 hashGenesisBlock("0xcf3c034d6883879c68b7e176eb89cbd02f6c5f8cf081586a5c154b9ef974468b");
...
const string strMessageMagic = "IPOCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // IPOCoin: 1 day.
static const int64 nTargetSpacing = 300; // IPOCoin: 5 mins.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ipocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "IPOCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x52925dee5a6414c73606895490bdae69e44f557a995ecb167fc517d2d88b41d0");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Genesis: October 7, 2013 3:45:00 PM EDT";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1381865445;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 936095;

        if (fTestNet)
        {
            block.nTime    = 1381175100;
            block.nNonce   = 3513085;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc151afcf8922744e67a48a9986b68d9363812ad6d6d71b2ae41630961dac6fc7"));
