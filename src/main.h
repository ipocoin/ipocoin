...
static const int64 MAX_MONEY = 2000000 * COIN; // maximum of 2 million coins.
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 288 / 250; // 288 blocks found a day. Priority cutoff is 1 ICN day / 250 bytes.
    }
